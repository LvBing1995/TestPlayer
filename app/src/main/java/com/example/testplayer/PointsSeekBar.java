...
public class PointsSeekBar extends RelativeLayout{
    ...
    private PointsSeekBar.TCThumbView mThumbView;             // 滑动ThumbView
    private List<PointsSeekBar.PointParams> mPointList;             // 打点信息的列表
    private PointsSeekBar.OnSeekBarPointClickListener mPointClickListener;    // 打点view点击回调
    ...
    public PointsSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public PointsSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void addThumbView() {
        mThumbView = new PointsSeekBar.TCThumbView(getContext(), mThumbDrawable);
        RelativeLayout.LayoutParams thumbParams = new RelativeLayout.LayoutParams(mThumbDrawable.getIntrinsicHeight(), mThumbDrawable.getIntrinsicHeight());
        ...
        this.post(new Runnable() {
            ...
            public void run() {
                if (mIsChangePointViews) {
                    PointsSeekBar.this.removeAllViews();
                    if (mPointList != null) {
                        for (int i = 0; i < mPointList.size(); i++) {
                            PointsSeekBar.PointParams params = mPointList.get(i);
                            addPoint(params, i);
                        }
                    }
                    addThumbView();
     ...
     * @param index
     */
    public void addPoint(PointsSeekBar.PointParams pointParams, final int index) {
        ...
        final PointsSeekBar.TCPointView view = new PointsSeekBar.TCPointView(getContext());
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(mThumbDrawable.getIntrinsicWidth(), mThumbDrawable.getIntrinsicWidth());
    ...
    private PointsSeekBar.OnSeekBarChangeListener mListener;

    public void setOnSeekBarChangeListener(PointsSeekBar.OnSeekBarChangeListener listener) {
        mListener = listener;
    }

    public interface OnSeekBarChangeListener {

        void onProgressChanged(PointsSeekBar seekBar, int progress, boolean fromUser);

        void onStartTrackingTouch(PointsSeekBar seekBar);

        void onStopTrackingTouch(PointsSeekBar seekBar);
    }
     ...
     * @param listener
     */
    public void setOnPointClickListener(PointsSeekBar.OnSeekBarPointClickListener listener) {
     ...
     * @param pointList
     */
    public void setPointList(List<PointsSeekBar.PointParams> pointList) {
